...
import s from "./PrezentForm.module.css";
...
export default function PrezentForm({ onClose }: Props) {
  ...
  const triggerDownload = () => {
    ...
    link.href = "/docs/Полимерные технологии Презентация.pdf"; 
    link.download = "Полимерные технологии Презентация.pdf";
            ...
            {!isSuccess ? (
              <>
                <div className={s.header}>
                  ...
                  <h3 className={s.popTitle}>Скачать каталог и презентацию </h3>
                </div>

                <p className={s.popText}>
                  Мы ценим наших новых и постоянных клиентов. <br /><br /> Пожалуйста,
                  заполните форму и мы отправим Вам презентацию в формате pdf.
                </p>
                      ...
                      <span className={s.submitContent}>
                        {isSubmitting ? (
                          ...
                          <>
                            ...
                            Скачать презентацию в фомате .pdf <br className={s.mob} /> 
                          </>
                        )}
                      </span>
                    </button>
